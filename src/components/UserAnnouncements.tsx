...
function UserAnnouncements() {
    ...
    return (
        <div className="UserAnnouncementDiv">
            <div className="AnnouncementField">

            </div>

            <div className="RulesField">
                <div id="RulesReg-Top">
                    <h2 id="UC">University of Cebu</h2>
                    <h4>COLLEGE OF INFORMATION AND COMPUTER STUDIES</h4>
                </div>
                <div id="Rules-Div">
                    <div id="Rules-Top">
                        <h1 className="title">SIT-IN RULES </h1>
                    </div>
                    <div id="Rules-Body">
                        <ul className="RulesUl">
                            <li className="RulesLi">First Offense - The Head or the Dean or OIC recommends to the Guidance Center for a suspension from classes for each offender.</li>
                            <li className="RulesLi">Second and Subsequent Offenses - A recommendation for a heavier sanction will be endorsed to the Guidance Center.</li>
                        </ul>
                    </div>
                </div>
                <div id="Regulations-Div">
                    <div id="Regulations-Top">
                        <h1 className="title">LAB RULES & REGULATIONS</h1>
                    </div>
                    <div id="Regulations-Body">
                        <p id="description">To avoid embarrassment and maintain camaraderie with your friends and superiors at our laboratories, please observe the following:</p>
                        ...
                        <ul className="RulesUl">
                            <li className="RegulationsLi" >Do not get inside the lab unless the instructor is present.</li>
                            <li className="RegulationsLi">All bags, knapsacks, and the likes must be deposited at the counter.</li>
                            <li className="RegulationsLi">Follow the seating arrangement of your instructor.</li>
                            <li className="RegulationsLi">At the end of class, all software programs must be closed.</li>
                            <li className="RegulationsLi">Return all chairs to their proper places after using.</li>
                        </ul>
