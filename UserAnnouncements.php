...
<div class="UserAnnouncementDiv">
    ...
    <div class="RulesField">
        ...
        <div id="Rules-Div">
            <div id="Rules-Top">
                <h1 class="title">SIT-IN RULES </h1>
            </div>
            <div id="Rules-Body">
                <ul class="RulesUl">
                    <li class="RulesLi">First Offense - The Head or the Dean or OIC recommends to the Guidance Center for a suspension from classes for each offender.</li>
                    <li class="RulesLi">Second and Subsequent Offenses - A recommendation for a heavier sanction will be endorsed to the Guidance Center.</li>
                </ul>
            </div>
        </div>
        ...
        <div id="Regulations-Div">
            <div id="Regulations-Top">
                <h1 class="title">LAB RULES & REGULATIONS</h1>
            </div>
            <div id="Regulations-Body">
                ...
                <ul class="RulesUl">
                    <li class="RegulationsLi" >Do not get inside the lab unless the instructor is present.</li>
                    <li class="RegulationsLi">All bags, knapsacks, and the likes must be deposited at the counter.</li>
                    <li class="RegulationsLi">Follow the seating arrangement of your instructor.</li>
                    <li class="RegulationsLi">At the end of class, all software programs must be closed.</li>
                    <li class="RegulationsLi">Return all chairs to their proper places after using.</li>
                </ul>
